  ...
  return (
    <section className="relative overflow-hidden bg-navy py-20 sm:py-24">
      ...
      <div className="pointer-events-none absolute inset-0">
        <div className="absolute -top-24 right-[10%] h-80 w-80 rounded-full bg-primary/20 blur-[110px]" />
      ...
      <div className="relative mx-auto grid max-w-7xl gap-12 px-6 lg:grid-cols-2 lg:items-start lg:gap-16 lg:px-8">
        <AnimatedContainer>
          ...
          <p className="mt-5 max-w-xl text-base leading-relaxed text-slate-300 sm:text-[17px]">
            One message with what you sell and what is not working. A scope and
            a number back — usually the same day.
          </p>
